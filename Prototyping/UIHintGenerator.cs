...
namespace Prototyping
{
    public class UIHintGenerator : IGenerateControl
    {
        ...
        public UIHintGenerator(string propertyName, Type propertyType, DataForm dataForm)
        {
        ...
        protected static UIHintAttribute GetUiHintAttribute(DataForm dataForm, string propertyName)
        {
